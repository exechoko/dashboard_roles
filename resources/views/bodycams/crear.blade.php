...
@section('content')
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading">Nueva Bodycam</h3>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('bodycams.store') }}" method="POST">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="estado" class="form-control" required>
                                                ...
                                                <option value="dada_baja" {{ old('estado') == 'dada_baja' ? 'selected' : '' }}>Dada de Baja</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-6">
