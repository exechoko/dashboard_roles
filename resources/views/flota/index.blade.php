                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            {{-- INCLUSIÓN DE MODALES: Se incluyen aquí (fuera de la tabla y cards) para que Bootstrap las
                            encuentre y funcionen correctamente en ambas vistas. --}}
                            @forelse ($flota as $f)
                                @include('flota.modal.detalle')
                                @include('flota.modal.borrar')
                            @empty
                                {{-- Si no hay flota, no se incluyen modales --}}
                            @endforelse
                                    ...
                                    <div class="flota-card">
                                        ...
                                        <div class="flota-card-body">
                                            <div class="flota-card-item">
                                                ...
                                                <span>{{ $f->equipo->tipo_terminal->modelo }}</span>
                                            </div>
                                        ...
                                        <div class="flota-card-actions">
                                            {{-- El botón sigue apuntando a la modal que ya se incluyó fuera del loop --}}
                                    ...
                                    <tbody>
                                        @forelse ($flota as $f)
                                            <tr>
                                                ...
                                                <td>{{ $f->destino->nombre }}<br><small>{{ $f->destino->dependeDe() }}</small>
                                                </td>
