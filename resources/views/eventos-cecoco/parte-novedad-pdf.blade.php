...
<head>
    ...
    <style>
        ...
        .pn-titulo { font-size: 20px; color: #f5a623; font-weight: bold; margin: 0 0 14px; }
        table.pn-grid { width: 100%; border-collapse: collapse; margin-bottom: 14px; }
        table.pn-grid td { border: 1px solid #dcdcdc; padding: 6px 10px; vertical-align: top; }
        .pn-expediente-bar { background: #2f7fc1; color: #fff; font-weight: bold; font-size: 13px; padding: 8px 10px; }
        .pn-label { background: #eef1f4; font-weight: bold; width: 22%; color: #333; }
        .pn-valor { width: 28%; }
        .pn-full-label { background: #eef1f4; font-weight: bold; width: 15%; color: #333; }
        .pn-full-valor { width: 85%; white-space: pre-wrap; }
        table.pn-tabla { width: 100%; border-collapse: collapse; margin-top: 4px; }
        table.pn-tabla th { background: #2f7fc1; color: #fff; padding: 6px 8px; font-size: 11px; text-align: left; }
        table.pn-tabla td { border: 1px solid #dcdcdc; padding: 6px 8px; font-size: 11px; }
        table.pn-tabla tr:nth-child(even) td { background: #f7f9fa; }
        .pn-footer { margin-top: 24px; font-size: 10px; color: #888; border-top: 1px solid #ddd; padding-top: 6px; }
    </style>
</head>
<body>
...
<table class="pn-grid">
    ...
    <tr>
        ...
        <td class="pn-valor" colspan="3">{{ $servidor ?: '-' }}</td>
    </tr>
    <tr>
...
<table class="pn-tabla">
    ...
    <tbody>
        ...
        @empty
            <tr>
                <td colspan="7">Sin unidades asignadas.</td>
            </tr>
        @endforelse
    </tbody>
</table>
...
<div class="pn-footer">
    Generado el {{ now()->format('d/m/Y H:i') }} desde los datos del detalle del expediente (sin depender de la restauraci&oacute;n del expediente en CECOCO web).
</div>
