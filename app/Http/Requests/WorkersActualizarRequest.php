...
class WorkersActualizarRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()?->can('editar-configuracion-workers') === true;
    }
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $validator): void {
            $permitidas = ConfiguracionCatalogo::clavesDeGrupo('workers');
