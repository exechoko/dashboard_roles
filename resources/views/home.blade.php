                            ...
                            @can('ver-menu-dashboard')
                                <div class="tab-content" id="myTabContent2">
                                    ...
                                    <div class="tab-pane fade show active" id="novedades3" role="tabpanel"
                                        ...
                                        {{-- Card estado CCTV (LibreNMS) --}}
                                        <div class="row mb-4">
                                            <div class="col-12">
                                                <div class="card shadow-sm">
                                                    <div class="card-header d-flex align-items-center justify-content-between py-2"
                                                        style="background: linear-gradient(135deg,#064e3b,#047857); color:#fff;">
                                                        <span><i class="fas fa-video mr-2"></i><strong>Estado CCTV
                                                                (LibreNMS)</strong></span>
                                                    ...
                                                    <div class="card-body py-3">
                                                        ...
                                                        <div id="cctv-puestos-container" class="d-flex flex-wrap"
                                                            style="gap:1.25rem;">
                                        ...
                                        {{-- Card estado troncales SIP central telefónica --}}
                                        <div class="row mb-4">
                                            <div class="col-12">
                                                <div class="card shadow-sm">
                                                    <div class="card-header d-flex align-items-center justify-content-between py-2"
                                                        style="background: linear-gradient(135deg,#1e3a8a,#1d4ed8); color:#fff;">
                                                        <span><i class="fas fa-phone-volume mr-2"></i><strong>Troncales SIP
                                                                Central Telefónica</strong></span>
                                                    ...
                                                    <div class="card-body py-3">
                                                        ...
                                                        <div id="troncales-container" class="d-flex flex-wrap"
                                                            style="gap:1.25rem;">
                                                            <span class="text-muted">Cargando...</span>
                                                        </div>
                                                    </div>
...
@section('scripts')
    <script>
        ...
        // ── Monitor CCTV (LibreNMS) ─────────────────────────────────────────
        (function cctvMonitor() {
            var url = '{{ route("api.dashboard.estado-cctv") }}';
        ...
        // ── Monitor troncales SIP (Central telefónica 911) ───────────────────
        (function troncalesCentralTelefonicaMonitor() {
            var url = '{{ route("api.dashboard.estado-troncales-central-telefonica") }}';
