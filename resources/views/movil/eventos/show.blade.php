...
@section('content')
    ...
    @can('ver-expediente-cecoco')
        ...
        <div class="m-card__meta" style="margin-bottom:1rem;">
            ...
            <a href="https://wa.me/?text={{ $textoWaParteNovedad }}" target="_blank" rel="noopener" class="m-btn m-btn--outline" title="Compartir por WhatsApp">
            ...
            <a href="https://wa.me/?text={{ $textoWaPdfInterno }}" target="_blank" rel="noopener" class="m-btn m-btn--outline" title="Compartir por WhatsApp">
                <i class="fab fa-whatsapp"></i>
            </a>
        </div>
    @endcan
