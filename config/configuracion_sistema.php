    ...
    'grupos' => [
        ...
        'cecoco' => [
            ...
            'claves' => [
                ...
                'CECOCO_USER_PREFETCH_1'     => ['label' => 'Usuario prefetch worker 1', 'tipo' => 'text'],
                'CECOCO_PASSWORD_PREFETCH_1' => ['label' => 'Contraseña prefetch worker 1', 'tipo' => 'password'],
                'CECOCO_USER_PREFETCH_2'     => ['label' => 'Usuario prefetch worker 2', 'tipo' => 'text'],
                'CECOCO_PASSWORD_PREFETCH_2' => ['label' => 'Contraseña prefetch worker 2', 'tipo' => 'password'],
                'CECOCO_USER_PREFETCH_3'     => ['label' => 'Usuario prefetch worker 3', 'tipo' => 'text'],
                'CECOCO_PASSWORD_PREFETCH_3' => ['label' => 'Contraseña prefetch worker 3', 'tipo' => 'password'],
