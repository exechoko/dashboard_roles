...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="info-box">
                <p><strong>Su credencial de acceso es su correo electrónico institucional.</strong></p>
            ...
            <div class="warn-box">
                <p><strong>Importante:</strong> En caso de olvidar sus credenciales de acceso o tener inconvenientes para ingresar al sistema, deberá comunicarse con la <strong>Sección Técnica de la División 911 y V.V.</strong></p>
            </div>

            <p>Atentamente,<br>
            <strong>Sección Técnica - División 911 y V.V.</strong></p>
        </div>

        <div class="footer">
            <p>Este mensaje ha sido generado automáticamente por el Sistema CAR911.</p>
            <p>División 911 y Videovigilancia - Policía de Entre Ríos</p>
        </div>
    </div>
</body>
</html>
