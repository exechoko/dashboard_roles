...
@section('content')
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading">Nueva card de tecnología</h3>
        </div>
        ...
        <div class="section-body">
            ...
            <form action="{{ route('web-tecnologia.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @include('web-tecnologia._form', ['card' => null])
