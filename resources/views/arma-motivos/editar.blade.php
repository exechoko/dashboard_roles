                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="texto_acta" id="texto_acta" class="form-control @error('texto_acta') is-invalid @enderror" rows="2" maxlength="500">{{ old('texto_acta', $armaMotivo->texto_acta) }}</textarea>
                                    @error('texto_acta')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
