                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('tipo-camara.update', $tipoCamara->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-8">
                                        <div class="form-group">
                                            ...
                                            <label class="alert alert-light ml-3" for="tipo">Fija - Fija FR - Fija LPR - Domo - Domo Dual</label>
                                            <input type="text" name="tipo" class="form-control"
                                            value="{{ $tipoCamara->tipo }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-floating">
                                            ...
                                            <textarea class="form-control" name="observaciones" style="height: 100px">{{ $tipoCamara->observaciones }}</textarea>
                                        </div>
                                        <br>
