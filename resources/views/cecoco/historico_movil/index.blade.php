        ...
        <div id="resultado-section" style="display:none">
            ...
            <div class="row mb-3 no-print">
                ...
                <div class="col-md-6 text-right">
                    ...
                    <button id="btn-export-html" class="btn btn-export-html btn-lg mr-2">
...
(function () {
    ...
    function irAPunto(idx) {
        ...
        // Mover carro con transición suave
    ...
    /* ════════════════════════════════════════
       EXPORTAR RECORRIDO HTML
    ════════════════════════════════════════ */
    document.getElementById('btn-export-html').addEventListener('click', function() {
        if (!resultadoData || !registros.length) {
            swal('Atención','Primero procesá un archivo con recorrido.','warning');
            return;
        }

        const html = construirHtmlRecorridoExportable(resultadoData);
        const meta = resultadoData.metadata || {};
        const filename = 'recorrido-' + slugArchivo(meta.recurso || 'movil') + '-' + slugArchivo(meta.fecha_inicio || '') + '.html';
...
<head>
    ...
    <title>Recorrido del Móvil</title>
