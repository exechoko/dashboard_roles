...
class PasswordVault extends Model
{
    ...
    public static function getSystemTypes()
    {
        return [
            ...
            'windows' => ['label' => 'Windows', 'icon' => 'fas fa-windows'],
            'cecoco' => ['label' => 'Cecoco', 'icon' => 'fas fa-life-ring'],
            'dss' => ['label' => 'DSS', 'icon' => 'fas fa-video'],
            'anydesk' => ['label' => 'Anydesk', 'icon' => 'fas fa-cloud'],
            'radmin' => ['label' => 'Radmin', 'icon' => 'fas fa-cloud'],
            'policial' => ['label' => 'Páginas Policiales', 'icon' => 'fas fa-shield-alt'],
            'pg' => ['label' => 'Patagonia Green', 'icon' => 'fas fa-shield-alt'],
            'personal' => ['label' => 'Personal', 'icon' => 'fas fa-user'],
            'servidor' => ['label' => 'Servidor', 'icon' => 'fas fa-server'],
            'nms' => ['label' => 'NMS', 'icon' => 'fas fa-network-wired'],
            'router' => ['label' => 'Router', 'icon' => 'fas fa-network-wired'],
