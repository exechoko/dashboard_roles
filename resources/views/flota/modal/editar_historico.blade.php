                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="nuevas_imagenes[]" id="imagen1-{{ $h->id }}" class="form-control" accept="image/*;capture=camera">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="imagen2">Imagen 2</label>
                                    <input type="file" name="nuevas_imagenes[]" id="imagen2-{{ $h->id }}" class="form-control" accept="image/*;capture=camera">
                                </div>
                            </div>
                        </div>
