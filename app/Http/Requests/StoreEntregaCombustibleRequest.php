...
class StoreEntregaCombustibleRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'remito' => ['nullable', 'string', 'regex:/^[A-Za-z0-9\-]+$/', 'max:100'],
    ...
    public function messages(): array
    {
        return [
            ...
            'remito.regex' => 'El remito sólo admite letras, números y guiones (sin espacios ni otros símbolos).',
            'remito.max' => 'El remito no puede superar los 100 caracteres.',
