...
class HomeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Llamadas atendidas por CeCoCo en el mismo período, extraídas de los CDR
        // reales de la central telefónica (no del sistema de eventos/despacho).
        $cecoco_llamadas_atendidas = LlamadaCentralTelefonica::query()
            ->recibidas()
            ->atendidas()
            ->whereBetween('calldate', [$cecocoInicioSemana, $cecocoFinSemana])
            ->count();
